...
{/* Glow en arrière-plan */} <div className="absolute -top-40 -left-40 w-[400px] h-[400px] bg-green-500/20 rounded-full blur-3xl animate-pulse"></div> <div className="absolute -bottom-40 -right-40 w-[400px] h-[400px] bg-yellow-400/20 rounded-full blur-3xl animate-pulse"></div>
  ...
  <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row gap-4 sm:gap-6">
    ...
    prefetch
    className="px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r from-green-400 to-green-600 rounded-xl font-semibold text-lg shadow-lg hover:scale-105 transition-all flex items-center justify-center gap-2">
      Découvrir les cours
      <FaArrowRight />
    </Link>
    <Link
    prefetch
    className="px-6 py-3 sm:px-8 sm:py-4 bg-gray-800 rounded-xl font-semibold text-lg border border-gray-700 hover:bg-gray-700 transition-all">
      En savoir plus
    </Link>
  </div>
